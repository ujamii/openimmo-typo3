...
CREATE TABLE tx_openimmotypo3_domain_model_alter (
...
CREATE TABLE tx_openimmotypo3_domain_model_anhang (
	...
	`check` int(11) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_openimmotypo3_domain_model_bieterverfahren (
	...
	`beginn_bietzeit` datetime DEFAULT NULL,
...
CREATE TABLE tx_openimmotypo3_domain_model_check (
	`anhang` int(11) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_openimmotypo3_domain_model_versteigerung (
	...
	`zusatztermin` datetime DEFAULT NULL,
	`zvtermin` datetime DEFAULT NULL,
...
CREATE TABLE tx_openimmotypo3_domain_model_zustandangaben (
	`alter` int(11) unsigned DEFAULT '0' NOT NULL,
