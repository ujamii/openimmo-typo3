 ...
 * @XmlRoot ("land")
 */
class Land implements \TYPO3\CMS\Extbase\DomainObject\DomainObjectInterface, \TYPO3\CMS\Extbase\Persistence\ObjectMonitoringInterface {
	 ...
	 * @return Land
	 */
	public function setGeo(int $geo): Land {
		$this->geo = $geo;
		return $this;
	}
	 ...
	 * @return Land
	 */
	public function setKontaktperson(int $kontaktperson): Land {
