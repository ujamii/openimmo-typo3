    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_openimmotypo3_domain_model_uebertragung}.{#pid}=###CURRENT_PID### AND {#tx_openimmotypo3_domain_model_uebertragung}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
