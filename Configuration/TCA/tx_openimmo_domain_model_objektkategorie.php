    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_openimmo_domain_model_objektkategorie}.{#pid}=###CURRENT_PID### AND {#tx_openimmo_domain_model_objektkategorie}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'nutzungsart' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_nutzungsart',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
        ...
        'objektart' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_objektart',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'vermarktungsart' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_vermarktungsart',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
