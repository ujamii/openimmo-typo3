    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_openimmo_domain_model_anbieter}.{#pid}=###CURRENT_PID### AND {#tx_openimmo_domain_model_anbieter}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'immobilie' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_immobilie',
                'maxitems' => 9999,
                'appearance' => [
                    'collapseAll' => 1,
                    'levelLinksPosition' => 'top',
        ...
        'impressum_strukt' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_impressum_strukt',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
