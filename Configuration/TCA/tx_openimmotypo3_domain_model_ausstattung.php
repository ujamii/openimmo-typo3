    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_openimmotypo3_domain_model_ausstattung',
                'foreign_table_where' => 'AND {#tx_openimmotypo3_domain_model_ausstattung}.{#pid}=###CURRENT_PID### AND {#tx_openimmotypo3_domain_model_ausstattung}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'ausbaustufe' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_ausbaustufe',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'bad' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_bad',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'bauweise' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_bauweise',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'fahrstuhl' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_fahrstuhl',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'kueche' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_kueche',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'moebliert' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_moebliert',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'sicherheitstechnik' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_sicherheitstechnik',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
        ...
        'unterkellert' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmotypo3_domain_model_unterkellert',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
                    'levelLinksPosition' => 'top',
