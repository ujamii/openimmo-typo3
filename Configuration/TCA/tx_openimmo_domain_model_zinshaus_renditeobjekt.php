    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_openimmo_domain_model_zinshaus_renditeobjekt}.{#pid}=###CURRENT_PID### AND {#tx_openimmo_domain_model_zinshaus_renditeobjekt}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
