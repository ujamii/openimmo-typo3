    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_openimmo_domain_model_infrastruktur}.{#pid}=###CURRENT_PID### AND {#tx_openimmo_domain_model_infrastruktur}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'ausblick' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_ausblick',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
        ...
        'distanzen' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_distanzen',
                'maxitems' => 9999,
                'appearance' => [
                    'collapseAll' => 1,
                    'levelLinksPosition' => 'top',
        ...
        'distanzen_sport' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_distanzen_sport',
                'maxitems' => 9999,
                'appearance' => [
                    'collapseAll' => 1,
                    'levelLinksPosition' => 'top',
