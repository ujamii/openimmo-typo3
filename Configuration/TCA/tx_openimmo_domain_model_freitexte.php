    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_openimmo_domain_model_freitexte}.{#pid}=###CURRENT_PID### AND {#tx_openimmo_domain_model_freitexte}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'objekt_text' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_openimmo_domain_model_objekt_text',
                'maxitems' => 1,
                'appearance' => [
                    'collapseAll' => 0,
